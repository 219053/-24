...
def test_add_new_pet_with_valid_data(name='drakon', animal_type='-',
                                     age='3', pet_photo='img/c53b00c11c78fcbb5a71bec774b97b1f.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "кошечка", "-", "2", "1673418730_gas-kvas-com-p-anime-risunki-devushki-koshechki-40.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name="кошечка", animal_type="-", age=2):
...
########################################ДЗ#############################################################################
def test_add_new_pet_no_photo(name="собачка", animal_type="-", age="2"):
...
#
def test_add_pet_new_photo(pet_photo='img/1673311392_gas-kvas-com-p-sobaka-v-stile-anime-risunki-1.jpg'):
...
def test_add_new_pet_with_invalid_name(name=12345, animal_type='Дракон',
                                       age='1000', pet_photo='img/c53b00c11c78fcbb5a71bec774b97b1f.jpg'):
...
def test_add_new_pet_without_name(name='', animal_type='Дракон', age='10000',
                                     pet_photo='img/c53b00c11c78fcbb5a71bec774b97b1f.jpg'):
...
def test_add_new_pet_with_none_value_animal_type(name='Дракончик', animal_type='',
                                                 age='10000', pet_photo='img/c53b00c11c78fcbb5a71bec774b97b1f.jpg'):
...
def test_add_new_pet_with_invalid_age(name='Дракончик', animal_type='Дракон',
                                      age='тысяча', pet_photo='img/c53b00c11c78fcbb5a71bec774b97b1f.jpg'):
